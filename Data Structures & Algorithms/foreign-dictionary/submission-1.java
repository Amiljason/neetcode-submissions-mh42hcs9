class Solution {
    public List<Character> topSort(HashMap<Character, ArrayList<Character>> graph, HashMap<Character, Integer> inDegree) {
        ...
        // 1. Enqueue ONLY nodes with 0 in-degree
        ...
        while (!q.isEmpty()) {
            ...
            for (char nei : graph.get(curr)) {
                ...
                // 3. Only enqueue when ALL incoming dependencies are resolved
    ...
    public String foreignDictionary(String[] words) {
        ...
        // Collect ALL unique characters across all words
        for (String w : words) {
        ...
        for (int i = 0; i < words.length - 1; i++) {
            ...
            // Invalid prefix rule: "abc" before "ab" is invalid
        ...
        // Cycle detection: if not all unique nodes are sorted, a cycle exists
